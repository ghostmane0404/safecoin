...
data class AppColors(
    ...
    val buttonPrimary: ColorWrapper = ColorWrapper.BackgroundContentStroke(
    ...
    val buttonSecondary: ColorWrapper = ColorWrapper.BackgroundContentStroke(
        background = ColorWrapper.Simple(color = Palette.black),
        content = ColorWrapper.Simple(color = Palette.white),
        stroke = ColorWrapper.Simple(color = Color.Transparent),
    ),
    val buttonTertiary: ColorWrapper = ColorWrapper.BackgroundContentStroke(
